...
public class PartitionArmedModeAttributeDefinition extends BasicAttributeDefinition<Text, String> {
	...
	public PartitionArmedModeAttributeDefinition() {
		super(UUID.fromString("86b7d0e2-8fc1-4963-a54e-be1bd9859c14"), "Partition Armed Mode", ValueTypeBuilder.text().build(),
				null,
				true,
				false);
	}
